  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "munnar-alleppey-backpacking-tour",
              placement: "#book-container-munnar3",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Munar Allepy Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div id="book-container-munnar3"></div>
        <Footer />
        </div>
