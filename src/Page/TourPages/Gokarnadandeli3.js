  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "gokarna-dandeli-backpacking-tour-long-weekend-3-days-and-2-night",
              placement: "#book-container-gokarna3",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Gokarna Dandeli Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Gokarna Dandeli</div>
        ...
        <div id="book-container-gokarna3"></div>
        <Footer />
        </div>
...
export default Gokarnadandeli3
