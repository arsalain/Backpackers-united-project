  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Best Of Phuket And Krabi Tour Package (6Days/5Nights)</div>
        <div className='product-title-time' ><FaLocationDot className='product-title-icon' ></FaLocationDot><div >Karnataka</div>
        <LuClock9 className='product-title-icon1'></LuClock9><div >4 Days 3 Nights</div>
        </div>
        ...
        <div className='product-iternary' >
            <div className='product-iternary-left' >
                ...
                <div className='product-iternary-left-day'>
                <div className='product-iternary-left-day0' onClick={handleShow1}><div >Day 1 - Sightseeing and Chill</div>
                <div  className='product-iternary-left-day0-but'>
...
<div className='product-iternary-left-day'>
<div className='product-iternary-left-day0' onClick={handleShow2}><div >Day 2 - Trek and return back to bangalore </div>
                <div  className='product-iternary-left-day0-but'>
...
<div className='product-iternary-left-day'>
<div className='product-iternary-left-day0' onClick={handleShow2}><div >Day 4 - Trek and return back to bangalore </div>
                <div  className='product-iternary-left-day0-but'>
                  {show2 ? <IoMdArrowDropup className='product-iternary-left-day0-icon' />: 
                  <IoMdArrowDropdown className='product-iternary-left-day0-icon' />}
                  </div>
                 ...
                 <TbPointFilled className='product-iternary-left-day0-point-icon' >
                  ...
                  <div className='product-iternary-left-day'>
<div className='product-iternary-left-day0' onClick={handleShow2}><div >Day 5 - Trek and return back to bangalore </div>
                <div  className='product-iternary-left-day0-but'>
                  {show2 ? <IoMdArrowDropup className='product-iternary-left-day0-icon' />: 
                  <IoMdArrowDropdown className='product-iternary-left-day0-icon' />}
                  </div>
      ...
      <Productfaq title="I am a Solo Traveller, can I join the Group ?" content="Yes, our trips are designed to ensure that every traveler gets to experience the Nature, Culture, Heritage, and beauty of the place.
       We are one of the best community travel groups in India." />
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Phuket And Krabi</div>
...
export default Bestofphuketkrabi
