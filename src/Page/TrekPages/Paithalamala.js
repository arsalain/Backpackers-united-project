  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "paithalmala-trek",
              placement: "#book-container-paithalmala",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Paithalamala Trek</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Paithalamala</div>
        ...
        <div id="book-container-paithalmala"></div>
        <Footer />
        </div>
