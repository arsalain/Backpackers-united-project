...
const Tadiandamol = () => {
  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
              ...
              eventSlug: "tadiandamol-trek",
              placement: "#book-container-tadiandamol",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Tadiandamol Trek</div>
        ...
        <GiLevelThree className='product-title-icon1'></GiLevelThree><div >Difficulty - Easy Moderate</div></div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Tadiandamol</div>
        ...
        <div id="book-container-tadiandamol"></div>
        <Footer />
        </div>
