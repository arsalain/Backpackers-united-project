...
const Kodachadri = () => {
  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
              ...
              eventSlug: "kodachadri-trek-79e7",
              placement: "#book-container-kodachadri",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Kodachadri Trek</div>
        <div className='product-title-time' ><FaLocationDot className='product-title-icon' ></FaLocationDot><div >Karnataka</div>
        <LuClock9 className='product-title-icon1'></LuClock9><div >2 Days 2 Nights</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Kodachadri</div>
        ...
        <div id="book-container-kodachadri"></div>
        <Footer />
        </div>
