    ...
    const initWidget = () => {
        if (window.logout && window.logout.widget) {
            window.logout.widget.setConfig({
                eventSlug: "coorg-backpacking-tour-3nwk",
                placement: "#book-container-coorg",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Coorg Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Coorg</div>
        ...
        <div id="book-container-coorg"></div>
        <Footer />
        </div>
