  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "dudhsagar-trek-and-dandeli-sigthseeing-tour",
              placement: "#book-container-dudhsagar",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Dudhsagar Trek and Dandeli Exploration</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Dudhsagar</div>
        ...
        <div className='similar-body-intro-line'></div>
            <div className='similar-intro'>
              ...
              Dudhsagar Trek and Dandeli Exploration Inspiration
              </div>
        ...
        <div id="book-container-dudhsagar"></div>
        <Footer />
        </div>
