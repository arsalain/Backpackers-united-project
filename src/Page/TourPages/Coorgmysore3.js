  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "coorg-backpacking-tour-long-weekend-3-days-and-2-nights",
              placement: "#book-container-coorg3",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Coorg - Mysore Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div id="book-container-coorg3"></div>
        <Footer />
        </div>
