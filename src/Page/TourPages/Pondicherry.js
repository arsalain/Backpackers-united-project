  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "pondicherry-backpacking-tour",
              placement: "#book-container-pondicherry",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Pondicherry Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Pondicherry</div>
        ...
        <div id="book-container-pondicherry"></div>        
        <Footer />
        </div>
