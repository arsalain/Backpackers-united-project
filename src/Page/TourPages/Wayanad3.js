  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "wayanad-backpacking-tour-long-weekend-3-days-and-2-nights",
              placement: "#book-container-wayanad3",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Wayanad Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Wayanad</div>
        ...
        <div id="book-container-wayanad3"></div>
        <Footer />
        </div>
