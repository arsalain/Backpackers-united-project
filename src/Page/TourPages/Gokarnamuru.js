  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "gokarna-murudeshwar-backpacking-tour",
              placement: "#book-container-gokarnamuru",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Gokarna-Murudeshwara Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Gokarna-Murudeshwara</div>
        ...
        <div className='similar-body-intro-line'></div>
            <div className='similar-intro'>
              ...
              Gokarna-Murudeshwara Inspiration
              </div>
        ...
        <div id="book-container-gokarnamuru"></div>
        <Footer />
        </div>
