  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "kumara-parvatha-trek",
              placement: "#book-container-kumara",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Kumara Parvatha Trek</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div className='product-gal'>
          ...
          <div className='product-gal-head-title1'>A weekend in Kumara Parvatha</div>
        ...
        <div id="book-container-kumara"></div>
        <Footer />
        </div>
