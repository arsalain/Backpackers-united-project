  ...
  const initWidget = () => {
      if (window.logout && window.logout.widget) {
          window.logout.widget.setConfig({
              eventSlug: "hampi-backpacking-tour-3-days-2-nights",
              placement: "#book-container-hampi3",
  ...
  return (
    ...
    <div className='product-img'>
      ...
      <div className='product-img-body'>
        ...
        <div className='product-img-title' >Hampi Tour</div>
...
Duis convallis libero vel varius convallis</div>
        ...
        <div id="book-container-hampi3"></div>
        <Footer />
        </div>
